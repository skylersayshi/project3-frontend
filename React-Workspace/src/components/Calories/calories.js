...
const Calories = () => {
  ...
  function getItem(searchString) {
    const url = `https://api.nutritionix.com/v1_1/search/${searchString}?results=0:20&fields=item_name,brand_name,item_id,nf_calories&appId=631a2264&appKey=472c2175b7f61cb075c3015f90f5c274&limit=10`;
